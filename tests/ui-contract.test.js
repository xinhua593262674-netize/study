...
test("前端包含全量题库、完整知识表和本地审核流转能力", () => {
  ...
  for (const capability of ["hydrateAllQuestionDrawer", "hydratePageQuestionData", "hydrateKnowledgeTable", "updateLocalQuestion", "hydrateReleasePage", "hydrateTextbookPages", "findQuestionEvidence", "scoreQuestionEvidence", "renderQuestionOptions"]) {
